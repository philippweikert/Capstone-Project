...
public class PlantServiceTest {
    ...
    void shouldAddNewPlant(){
        Plant plant = new Plant(null, "Ficus elastica", "Gummibaum", "Schattig", "mäßig gießen", "ist vorhanden", "einaml im Jahr", "nicht notwendig");
        Plant savedPlant = new Plant("0815", "Ficus elastica", "Gummibaum", "Schattig", "mäßig gießen", "ist vorhanden", "einaml im Jahr", "nicht notwendig");
